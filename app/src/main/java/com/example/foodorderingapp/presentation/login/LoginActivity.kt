package com.example.foodorderingapp.presentation.login

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import com.example.foodorderingapp.presentation.MainActivity
            ...
            auth.signInWithEmailAndPassword(tasarim.emailEditText.text.toString(),tasarim.passEditText.text.toString())
                .addOnCompleteListener {  task ->
                    if (task.isSuccessful){
                        ...
                        Toast.makeText(this,"Hoş geldin : ${guncelKullanici}",Toast.LENGTH_SHORT).show()
